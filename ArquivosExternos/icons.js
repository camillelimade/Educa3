...
!(function(t) {
                ...
                if (null != n) {
                    ...
                    try {
                        if (((i = (n = n.call(t)).next), 0 === e)) {
                            ...
                            for (; !(u = (r = i.call(n)).done) &&
                                (a.push(r.value), a.length !== e); u = !0
                            );
                    } catch (t) {
                        (f = !0), (o = t);
                    } finally {
    ...
    function S(t) {
        (t._state = "rejected"),
        w(t), !t._handled && s && global.process.emit("unhandledRejection", t._data, t);
    }
    ...
    function F(t, n) {
        ...
        if (
            (t.v4shim &&
                ...
                f.push({ id: "fa-v4-font-face", addOn: "-v4-font-face" }), !u && t.customIconsCssPath)
        ) {
            var s =
