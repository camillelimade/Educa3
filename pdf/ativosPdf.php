...
LEFT JOIN devolucao ON emprestimo.idEmprestimo = devolucao.emprestimo_idEmprestimo WHERE emprestimo.StatusEmprestimo = 
1";
...
INNER JOIN livro ON emprestimo.livro_idLivro = livro.idLivro
LEFT JOIN devolucao ON emprestimo.idEmprestimo = devolucao.emprestimo_idEmprestimo WHERE emprestimo.StatusEmprestimo = 1";
...
if ($res->num_rows > 0) {
    ...
    <body>
        <div id='library-info'>
            <h1>Tabela de Empréstimos Ativos</h1>
            <p>
                Bem-vindo ao EducaBiblio, o seu sistema de biblioteca dedicado à promoção da educação e leitura! Abaixo, apresentamos os registros de empréstimos ativos.
            </p>
        </div>
        <table>
            <thead>
